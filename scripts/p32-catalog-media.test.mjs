...
const home = readFileSync("apps/web/components/home/PremiumHomeExperience.tsx", "utf8");
...
assert.match(home, /function ProductFallback/);
assert.match(home, /priceSoon: "السعر قريبًا"/);
assert.match(home, /heroProduct && heroImage \? <Image/);
assert.match(home, /image \? <Image[\s\S]*: <ProductFallback/);
