...
assert.match(operator,/auditLog\.create/);assert.match(operator,/reverseHarmonyLedgerEntry/);assert.match(operator,/getHarmonyCustomerDetail/);assert.match(api,/Manager approval is required/);assert.match(api,/Idempotency-Key/);assert.match(harmony,/Ledger timeline/);assert.match(harmony,/Available rewards/);
