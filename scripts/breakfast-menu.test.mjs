...
assert.match(experience, /const effectiveBreakfastGroup = selectedCategory === "breakfast" && !initialSearch/);
assert.match(experience, /isBreakfastProductInGroup\(product\.tags, effectiveBreakfastGroup\)/);
