...
assert.ok(view.includes("aria-controls") && view.includes("ArrowRight"), "Workspace tabs must expose keyboard and assistive-technology relationships.");
...
assert.ok(catalog.includes("aria-controls") && catalog.includes("ArrowRight"), "Catalog tabs must support keyboard navigation.");
