...
const copy = {
  ar: {
    ...
    harmony: "لحظات منسجمة، بطابع سالورا",
    defaultTitle: "اختر لحظتك، ودَع لنا الانسجام.",
    defaultIntro: "ريوق صباحي، قهوة وماتشا وحلوى — اختيارات طازجة وتفاصيل تصنع لحظة تستحق التذكّر.",
    explore: "اكتشف المنيو",
    location: "اعرف موقعنا",
    scroll: "مرّر للاكتشاف",
    selection: "مختاراتنا",
    menuTitle: "كل اختيار يحكي حكاية.",
  ...
  en: {
    ...
    harmony: "SALORA moments, in harmony",
    defaultTitle: "Choose the moment. We’ll create the harmony.",
    defaultIntro: "Breakfast, coffee, matcha and dessert — fresh selections and thoughtful details for moments worth remembering.",
    explore: "Explore the menu",
    location: "Find SALORA",
    scroll: "Scroll to discover",
    selection: "Our selection",
    menuTitle: "Every selection tells a story.",
